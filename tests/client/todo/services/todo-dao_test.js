...
describe('todo.dao', function() {
    ...
    beforeEach(inject(function($injector) {
        ...
        _TodoDAO = $injector.get('ArtistRepository');
    }))
    ...
    describe('createArtist', function() {
        it('should return the promise as an error - object is not a valid instanceof Todo', function() {
            ...
            var _onError = function(error) {
                ...
                expect(error.message).toEqual('Invalid artist to be created.');
            }

            _TodoDAO
              .createArtist(_invalidTodo)
              .then(_onSuccess)
              .catch(_onError);
        ...
        it('should return the just created artist', function() {
    ...
    describe('deleteArtist', function() {
        ...
        it('should try to delete artist, but server returns error - 400', function() {
            var _id = "abc";
        ...
        it('should delete artist correctly', function() {
          var _id = "abc";
