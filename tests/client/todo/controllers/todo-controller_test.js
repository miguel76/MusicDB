...
describe('todos.controller', function() {
    ...
    describe('init', function() {
        ...
        it('should have artist as the instanceof Todo', inject(function($controller) {
            $controller(CONTROLLER_NAME, {$scope: _scope});
    ...
    describe('createArtist', function() {
        it('should try to createArtist, but server returns error - 400', inject(function($controller) {
            ...
            _scope.todoCtrl.createArtist(_todo);
        ...
        it('should createArtist correctly', inject(function($controller) {
    ...
    describe('deleteArtist', function() {
      it('should try to deleteArtist, but server returns error - 400', inject(function($controller) {
        var _id = "1";
        var _response = [{_id: 1}];
        ...
        _scope.todoCtrl.deleteArtist(_id);
      ...
      it('should deleteArtist correctly', inject(function($controller) {
        var _id = "1";
