...
describe('todo.e2e', function() {
    var SUBMIT_TODO_BUTTON = '#submit-artist-button';
    var TODO_MODEL = 'todosCtrl.todo.todoMessage';
    var CLOSE_TODO = '.artist-done';
    ...
    describe('addition', function() {
        it('should add a new artist - enter', function() {
        ...
        it('should add a new artist - click', function() {
    ...
    describe('deletion', function() {
        it('should delete a artist', function() {
